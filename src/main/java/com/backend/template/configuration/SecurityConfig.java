...
//
//import com.backend.template.base.authorization.*;
...
//    }
//
//    private static final String[] AUTH_WHITELIST = {"/v3/api-docs/**", "/api-docs/**", "/swagger-ui/**",
//    };
//
//    // 비밀번호 암호화
//    @Bean
...
//
//        corsConfiguration.setAllowedOriginPatterns(List.of("http://localhost:5173",  "http://wear-frontend.s3-website.ap-northeast-2.amazonaws.com"
//        ));
//
//        //허용할 헤더 설정
