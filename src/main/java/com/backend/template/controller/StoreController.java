...
import com.backend.template.service.StoreService;
...
public class StoreController {
    ...
    public ResponseEntity<List<StoreResponseDto>> getStores(
        ...
        List<StoreResponseDto> responses;
        if (category != null) {
            responses = this.storeService.findByPointAndCategory(lat, lon, category);
        } else {
            responses = this.storeService.findByPoint(lat, lon);
        }
